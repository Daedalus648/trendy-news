jQuery(document).ready(function () {
    $.ajax({
        url:"http://newsapi.org/v2/top-headlines?country=jp&apiKey=ceaaecac2d2e4b92a4e8739a2e6b8e32",
        type: "GET",
        dataType : "json",
        ...
        error: function(){
            if($.ajax().url !== "http://newsapi.org/v2/top-headlines?country=jp&apiKey=ceaaecac2d2e4b92a4e8739a2e6b8e32"){
